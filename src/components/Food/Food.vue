  ...
  <div class="food" v-show="isShow">
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div class="buy" v-else @click="addToCart">加入购物车
        </div>
      </div>
      ...
      <div class="rating">
        ...
        <div class="rating-wrapper">
          <ul>
            <li class="rating-item border-1px" v-for="(rating, index) in fliterRatings" :key="index">
              <div class="user">
              ...
              <p class="text">
                <span class="iconfont" :class="rating.rateType===0?'icon-thumb_up':'icon-thumb_down'"></span>{{rating.text}}
              </p>
            </li>
          </ul>
        </div>
...
export default {
  ...
  methods: {
    toggleShow () {
      ...
      // 单例
      if (this.isShow) { // 证明food显示了,但是界面不一定更新了
        this.$nextTick(() => {
          if (!this.scroll) { // 如果没有创建scroll，创建
