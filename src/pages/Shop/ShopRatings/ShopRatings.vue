  ...
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(shopRating,index) in fliterRatings" :key="index">
            <div class="avatar">
              <img width="28" height="28" :src="shopRating.avatar">
            </div>
            <div class="content">
              <h1 class="name">{{shopRating.username}}</h1>
              <div class="star-wrapper">
                <div>
                  <Star :score="shopRating.score" :size="24"/>
                </div>
                <span class="delivery">{{shopRating.deliveryTime}}</span>
              </div>
              <p class="text">{{shopRating.text}}</p>
              <div class="recommend">
                <span class="iconfont" :class="shopRating.rateType===0?'icon-thumb_up':'icon-thumb_down'"></span>
              </div>
              <div class="time">{{shopRating.rateTime | dateString}}</div>
            </div>
          </li>
        </ul>
      </div>
